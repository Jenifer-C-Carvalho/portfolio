// elementos de informação dos cards
const cardInfo = document.querySelector('.cardInfo');
const cardHTML = document.querySelector('#HTML');
const cardCSS = document.querySelector('#CSS');
const cardGIT = document.querySelector('#GIT');
const cardJS = document.querySelector('#JS');
const cardREACT = document.querySelector('#REACT');
